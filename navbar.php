  ...
  <script>
    function redirectPage(input) {
      ...
      <nav>
        ...
        <ul class="list-item">
            <button onClick="redirectPage('github')"><i class="fab fa-github"></i></button>
            <button onClick="redirectPage('email')"><i class="far fa-envelope"></i></button>
            <button onClick="redirectPage('location')"><i class="fas fa-map-marker-alt"></i></button>
          </ul>
      </nav>
    </header>
